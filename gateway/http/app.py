...
from gateway.http.routers import parent_dashboard, parent_evaluations, parent_supports
from gateway.realtime.socket import socket_app

from .routers import (
    ia_sessions as ia_sessions_router,
    app_info,
    auth,
    files,
    health,
...
def create_app() -> FastAPI:
    ...
    app.include_router(ia_sessions_router.router, prefix="/api/v1")
    app.include_router(parent_dashboard.router, prefix="/api/v1")
    app.include_router(parent_evaluations.router, prefix="/api/v1")
    app.include_router(parent_supports.router, prefix="/api/v1")
