...
export const getConfig = async (token: string = '') => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/evaluations/config`, {
		method: 'GET',
		headers: {
...
export const exportAllFeedbacks = async (token: string = '') => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/evaluations/feedbacks/all/export`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createNewFeedback = async (token: string, feedback: object) => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/evaluations/feedback`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFeedbackById = async (token: string, feedbackId: string) => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/evaluations/feedback/${feedbackId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
