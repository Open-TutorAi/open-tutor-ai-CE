<script>
    ...
    <div class=" bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-4 p-4 mt-10" 
      role="region" 
    ...
    <div class="bg-white dark:bg-gray-800 max-w-60 rounded-lg shadow-sm p-6 flex-grow" 
      ...
      <ul class="flex flex-col space-y-8 list-none m-0 p-0">
        ...
        <!-- Engagement Card -->
    <div class="bg-white dark:bg-gray-800 max-w-60 rounded-lg shadow-sm mb-4 p-4 mt-4" 
      role="region" 
