        ...
        <li class="flex items-center">
          ...
          <div class="relative flex justify-center w-16">
            {#if module.status === "completed"}
              <div 
                class="bg-blue-500 dark:bg-blue-600 w-6 h-6 rounded-full flex items-center justify-center "
                aria-hidden="true">
                <!-- Check icon -->
            ...
            {:else if module.status === "in-progress"}
              <div 
                class="w-6 h-6 rounded-full border-2 border-blue-600 flex items-center justify-center "
                aria-hidden="true">
                <div class="bg-blue-500 dark:bg-blue-600 w-2 h-2 rounded-full"></div>
              </div>
            {:else}
              <div 
                class="w-6 h-6 rounded-full border border-gray-300 bg-white "
                aria-hidden="true">
              </div>
            {/if}
