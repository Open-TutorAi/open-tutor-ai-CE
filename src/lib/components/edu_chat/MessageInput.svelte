									...
									<div class="pl-[1px] flex items-center gap-2 text-sm dark:text-gray-500">
										<img
											...
											src={$models.find((model) => model.id === atSelectedModel.id)?.info?.meta
												...
												($i18n.language === 'dg-DG'
													? `/doge.png`
													: `${TUTOR_BASE_URL}/static/favicon.png`)}
										/>
			...
			>
				<div class="">
					...
					{:else}
						...
						>
							<div
								class="flex-1 flex flex-col relative w-full rounded-4xl {transparentBackground ? 'shadow-xl shadow-black/20 dark:shadow-black/40 bg-white/40 backdrop-blur-md dark:bg-gray-800/60 border-white/40 dark:border-gray-600/50' : 'shadow-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700'} dark:text-gray-100 border px-6 py-2 max-w-3xl mx-auto mb-10 {transparentBackground ? 'hover:shadow-2xl hover:shadow-black/30 transition-all duration-300' : ''} overflow-hidden"
								...
								<div class="flex items-center gap-2 py-2.5 w-full">
									<div class="flex-1 min-w-0">
										{#if $settings?.richTextInput ?? true}
											<div class="scrollbar-hidden text-left bg-transparent dark:text-gray-100 outline-hidden w-full resize-none max-h-80 overflow-y-auto break-words">
												<RichTextInput
