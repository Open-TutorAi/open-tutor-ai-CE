		...
		<div class="m-auto pb-10 flex flex-col justify-center">
			<div class="max-w-md">
				<div class="text-center dark:text-white text-2xl font-medium z-50">
					...
					{$i18n.t('Contact Admin for TutorAI Access')}
				</div>

				<div class=" mt-4 text-center text-sm dark:text-gray-200 w-full">
					{$i18n.t('Your account status is currently pending activation.')}<br />
					{$i18n.t(
						'To access the TutorAI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.'
					)}
				</div>
