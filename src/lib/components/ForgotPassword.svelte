...
<div class="min-h-screen w-full flex flex-col md:flex-row font-sans bg-gray-100">
	<!-- Left Panel -->
	<div class="w-full md:w-5/12 bg-[#E6F0FA] p-6 md:p-12 flex flex-col justify-center">
		<div class="mx-auto max-w-md w-full">
			<h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-3">{$i18n.t('Password Recovery')}</h2>
			...
			<div class="space-y-5">
				<div class="flex items-center">
					...
					<span class="text-sm md:text-base text-gray-700">{$i18n.t('Enter your email address')}</span>
				</div>
				<div class="flex items-center">
					<div
						class="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-blue-600 font-semibold mr-4"
					...
					<span class="text-sm md:text-base text-gray-700">{$i18n.t('Check your inbox for reset link')}</span>
				</div>
				<div class="flex items-center">
					<div
						class="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-blue-600 font-semibold mr-4"
			...
			<!-- Help Section -->
			<div>
				<p class="font-semibold text-gray-800 text-sm md:text-base mb-3">{$i18n.t('Need help?')}</p>
	...
	<div class="w-full md:w-7/12 bg-white p-6 md:p-12 flex flex-col justify-center relative">
		...
		<div class="mx-auto max-w-md w-full">
			<h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-3">{$i18n.t('Forgot Password?')}</h2>
			<p class="text-sm md:text-base text-gray-600 mb-8">
