...
<div class="page">
	...
	<div class="page-header" in:fade={{ duration: 250 }}>
		<div>
			...
			<p class="page-sub">
				{$i18n.t("Créez des quiz personnalisés grâce à l'IA et suivez les performances")}
			</p>
		</div>
		<div class="stats-row">
			<div class="stat-chip">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="field">
								...
								/>
								<span class="hint"
									>{$i18n.t('Un titre clair aide vos étudiants à identifier le quiz')}</span
								>
							</div>
							<div class="field">
								...
								<span class="hint"
									>{$i18n.t("L'IA utilisera le contenu du cours pour générer les questions")}</span
								>
							</div>
						</div>
					</div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="field">
							...
							<div class="type-list">
								{#each [{ id: 'QCM', label: $i18n.t('QCM') }, { id: 'True/False', label: $i18n.t('Vrai / Faux') }, { id: 'Short Answer', label: $i18n.t('Réponse courte') }] as type}
									<button
										type="button"
										class="type-opt"
			...
			<div in:fade={{ duration: 200 }}>
				<div class="review-bar">
					<div>
						...
						<p class="review-meta">
							{questions.length}
							{$i18n.t('questions')} · {$i18n.t('Vérifiez avant de publier')}
						</p>
					</div>
											...
											{#each question.options as option, oi}
												<div class="opt-row">
													<button
														...
														aria-label="{$i18n.t('Marquer comme correcte')} {String.fromCharCode(
															65 + oi
														)}"
													>
		...
		<div class="analytics-wrap" in:fade={{ duration: 200 }}>
			...
			{:else}
				<div class="card empty-card">
					...
					<p class="empty-sub">
						{$i18n.t('Sélectionnez un quiz publié pour visualiser ses statistiques détaillées')}
					</p>
				</div>
			{/if}
		</div>
