...
<div class="page">
	...
	{#if activeTab === 'create'}
		...
		{#if step === 1}
			<!-- Single column: "Informations générales" on top, "Configuration" below -->
...
<style>
	...
	*, *::before, *::after { box-sizing: border-box; }
	...
	:global(.dark) .page-header { border-color: rgba(51, 65, 85, 0.6); }
	...
	/* ── Header stat chips ── */
	.stats-row { display: flex; gap: 16px; flex-wrap: wrap; align-items: stretch; }
	...
	.stat-chip:hover { transform: translateY(-2px); box-shadow: 0 8px 20px -6px rgba(0,0,0,.04); }
	:global(.dark) .stat-chip { background: #1e293b; border-color: #334155; box-shadow: none; }

	.stat-chip .val { font-size: 22px; font-weight: 700; line-height: 1; letter-spacing: -0.015em; }
	.stat-chip span:not(.val) { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: .04em; color: #7f8fa4; }
	:global(.dark) .stat-chip span:not(.val) { color: #a1b0c0; }

	/* Colored chip variants */
	.val-blue { color: #2563eb; }
	.stat-chip:has(.val-blue) { background: #f1f6ff; border-color: #e0e9fe; }
	:global(.dark) .stat-chip:has(.val-blue) { background: rgba(37,99,235,.1); border-color: rgba(37,99,235,.3); }

	.val-green { color: #10a34a; }
	.stat-chip:has(.val-green) { background: #f1fdf4; border-color: #dcfce7; }
	:global(.dark) .stat-chip:has(.val-green) { background: rgba(16,163,74,.1); border-color: rgba(16,163,74,.3); }

	.val-amber { color: #d97706; }
	.stat-chip:has(.val-amber) { background: #fffbef; border-color: #fef3c7; }
	:global(.dark) .stat-chip:has(.val-amber) { background: rgba(217,119,6,.1); border-color: rgba(217,119,6,.3); }
	...
	.step-item { display: flex; align-items: center; gap: 7px; font-size: 12px; color: #94a3b8; }
	...
	.card-head { padding: 1.25rem 1.5rem 1rem; border-bottom: 1px solid #f1f5f9; }
	...
	:global(.dark) .inp { background: #0f172a; border-color: #334155; color: #e2e8f0; }
	...
	.time-num { -moz-appearance: textfield; }

	.custom-number-wrapper { position: relative; display: inline-flex; align-items: center; }
	...
	.time-num:focus { border-color: #3b82f6; box-shadow: 0 0 0 3px rgba(59,130,246,.1); }
	...
	.spinner-btn {
		...
		cursor: pointer;
		display: flex; align-items: center; justify-content: center;
		color: #888; height: 14px; width: 16px;
		transition: color 0.1s, transform 0.1s;
	}
	.spinner-btn:hover { color: #2563eb; }
	.spinner-btn:active { transform: scale(0.9); }

	.time-row { display: flex; align-items: center; gap: 8px; margin-top: 6px; }
	.time-unit { font-size: 14px; color: #64748b; font-weight: 500; }
	...
	.btn-remove-option:hover { background: #fef2f2; border-color: #fecaca; color: #dc2626; }
	:global(.dark) .btn-remove-option { background: #1e293b; border-color: #334155; }
	:global(.dark) .btn-remove-option:hover { background: rgba(220,38,38,.15); border-color: rgba(220,38,38,.3); color: #fca5a5; }

	/* Add a new MCQ option */
	.btn-add-option {
		display: inline-flex; align-items: center; gap: 5px;
		padding: 6px 12px;
		background: #f0f9ff; border: 1px dashed #bfdbfe;
		border-radius: 7px; font-size: 12px; font-weight: 500;
		color: #2563eb; cursor: pointer; transition: all 0.15s;
		font-family: inherit; margin-top: 4px;
		width: 100%; justify-content: center;
	}
	.btn-add-option:hover { background: #eff6ff; border-style: solid; border-color: #2563eb; }
	:global(.dark) .btn-add-option { background: rgba(37,99,235,.08); border-color: rgba(37,99,235,.25); color: #93c5fd; }
	:global(.dark) .btn-add-option:hover { background: rgba(37,99,235,.15); border-color: rgba(147,197,253,.5); }
	...
	.review-actions { display: flex; gap: 10px; align-items: center; flex-wrap: nowrap; }
	.review-actions select { width: 110px; min-width: 110px; flex-shrink: 0; }
	.review-actions button { white-space: nowrap; flex-shrink: 0; display: inline-flex; align-items: center; gap: 4px; }
	...
	.q-type { font-size: 11px; padding: 2px 6px; background: #eff6ff; color: #1d4ed8; border-radius: 4px; font-weight: 600; }
