...
<script lang="ts">
	...
	// --- Preferences ---
	let currentTheme: 'light' | 'dark' | 'system' = ($theme as 'light' | 'dark' | 'system') || 'system';
		...
		try {
			...
			if (profileRes.ok) {
				...
				profile = {
					...
					avatar: avatarUrl || '/static/student-avatar.png'
				};
				...
				user.update((u) => {
					...
					return {
						...
						profile_image_url: avatarUrl || u.profile_image_url || '/static/student-avatar.png',
						_avatar_ts: Date.now()
					} as any;
				});
					...
					<div class="form-stack">
						...
						<div class="input-group">
							...
							<input
								...
								class="field"
								placeholder={$i18n.t('Votre prénom...')}
							/>
						</div>
						<!-- Last name -->
						<div class="input-group">
						...
						<div class="input-group">
							...
							<input
								...
								class="field"
								placeholder={$i18n.t('votre@email.com')}
							/>
						</div>
					</div>
						...
						<div class="pref-card">
							...
							<div class="pref-card-content">
								...
								<div class="lang-selector">
									{#each [{ code: 'fr-FR', flag: '🇫🇷', name: 'Français' }, { code: 'en-US', flag: '🇺🇸', name: 'English' }, { code: 'ar-MA', flag: '🇲🇦', name: 'العربية' }] as langOpt}
										<button
...
<style>
	...
	:global(.dark) .panel-icon.blue {
		background: #1e3a8a;
		color: #93c5fd;
	}
	:global(.dark) .panel-icon.purple {
		background: #2d1b69;
		color: #c4b5fd;
	}
	:global(.dark) .panel-icon.green {
		background: #064e3b;
		color: #6ee7b7;
	}
