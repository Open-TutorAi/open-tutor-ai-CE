<script lang="ts">
    ...
    let students = [
        { id: '1', name: 'Lahcen ECHCHARIY', date: '12 Sept 2023', progress: 85, note: '16/20', status: 'Active' },
        { id: '2', name: 'Abdelhadi Ait Boubker', date: '15 Sept 2023', progress: 42, note: '16/20', status: 'Active' },
        { id: '3', name: 'Abdelaziz Boukdous', date: '10 Sept 2023', progress: 92, note: '19/20', status: 'Active' },
        { id: '4', name: 'Mourad Amribd', date: '18 Sept 2023', progress: 15, note: '05/20', status: 'Struggling' },
        { id: '5', name: 'Hafid Qastali', date: '12 Sept 2023', progress: 68, note: '14/20', status: 'Inactive' }
    ];
