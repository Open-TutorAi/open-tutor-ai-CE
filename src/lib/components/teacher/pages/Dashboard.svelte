...
<div class="dashboard">
	...
	<div class="stats-row">
		...
		<div
			class="stat-card cursor-pointer hover:scale-[1.01] active:scale-95 transition-all"
			...
			{#each courses as course (course.id)}
				...
				>
					...
					<div class="cc-tags">
						...
						<span
							class="ctag"
							style="background:{levelColor(course.level)}18; color:{levelColor(course.level)};"
						>
				...
				<div class="course-card" in:fly={{ y: 12, duration: 250 }}>
					...
					<div class="cc-tags">
						<span class="ctag ctag-gray">
							...
							{quiz.total_questions > 1 ? $i18n.t('questions') : $i18n.t('question')}
						</span>
						{#if quiz.time_limit}
...
<style>
	...
	:global(.dark) .stat-blue {
		background: rgba(37, 99, 235, 0.15);
	}
	:global(.dark) .stat-green {
		background: rgba(22, 163, 74, 0.15);
	}
	:global(.dark) .stat-purple {
	...
	:global(.dark) .course-card.new-highlight {
		box-shadow:
			0 0 0 3px rgba(96, 165, 250, 0.2),
			0 12px 24px -8px rgba(59, 91, 219, 0.3);
	}
	...
	:global(.dark) .ctag-blue {
		background: rgba(59, 91, 219, 0.2);
		color: #93c5fd;
	}
	:global(.dark) .ctag-gray {
		background: #334155;
		color: #94a3b8;
	}
	...
	:global(.dark) .cc-copy-btn {
		background: #1e293b;
		border-color: #334155;
	}
	:global(.dark) .cc-copy-btn.copied {
		background: #052e16;
		border-color: #166534;
		color: #86efac;
	}
	...
	:global(.dark) .cc-delete-btn {
		background: rgba(239, 68, 68, 0.1);
		border-color: rgba(239, 68, 68, 0.3);
		color: #f87171;
	}
	:global(.dark) .cc-delete-btn:hover {
		background: #ef4444;
		border-color: #ef4444;
		color: white;
	}
	...
	:global(.dark) .cc-manage-btn {
		background: #334155;
		border-color: #475569;
		color: #e2e8f0;
	}
	:global(.dark) .cc-manage-btn:hover {
		background: #3b5bdb;
		border-color: #3b5bdb;
	}
