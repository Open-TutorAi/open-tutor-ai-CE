		...
		<div class="plan-section">
			<div class="section-header">
				...
				<p class="section-hint">
					{$i18n.t('Ajoutez, modifiez ou supprimez des chapitres et sections')}
				</p>
			</div>
						...
						<div class="chapter-header">
							...
							{:else}
								...
								<div class="chapter-actions">
									<button
										class="btn-icon edit"
										on:click={() => startEditChapter(chapter)}
								...
								<div class="section-item" in:fly={{ y: 10, duration: 200 }}>
									...
									{:else}
										...
										<div class="section-actions">
											<button
												class="btn-icon edit"
												on:click={() => startEditSection(chapter.id, section)}
												title={$i18n.t('Modifier')}
											>
												<svg
													fill="none"
											...
											<button
												class="btn-icon delete"
												on:click={() => deleteSection(chapter.id, section.id)}
												title={$i18n.t('Supprimer')}
											>
												<svg
													fill="none"
