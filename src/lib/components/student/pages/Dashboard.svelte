...
<div class="mb-6">
	<h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">{$i18n.t('Dashboard Overview')}</h2>
</div>
...
<div class="fixed inset-0 backdrop-blur-sm bg-white/30 dark:bg-black/30 flex items-center justify-center z-50">
	<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md mx-auto relative">
		...
		<h2 class="text-center text-xl font-bold mb-2 text-gray-900 dark:text-white">Enter the course code provided by your teacher</h2>
		<p class="text-center text-gray-500 dark:text-gray-400 mb-6">The code is a 6-8 character alphanumeric string</p>
		...
		<!-- Help Text -->
		<p class="text-center text-gray-500 dark:text-gray-400 mb-6">Need a code? Ask your teacher or institution</p>
		...
		<div class="text-center">
			...
			<a href="#" class="text-blue-600 dark:text-blue-400 hover:underline">create your own course</a>
		</div>
	</div>
</div>
{/if}
...
<div class="fixed inset-0 backdrop-blur-sm bg-white/30 dark:bg-black/30 flex items-center justify-center z-50">
	<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md mx-auto relative">
		...
		<!-- Title -->
		<h2 class="text-center text-xl font-bold text-gray-900 dark:text-white">Create Personalized Tutorials for any Subject or Topic</h2>
		...
		<h3 class="text-center text-lg font-medium mb-6 text-gray-900 dark:text-white">Create Tour Learning Path</h3>
		...
		<div class="space-y-4 mb-10 px-4">
			<div class="flex items-center gap-4">
				...
				<span class="text-gray-800 dark:text-gray-200">Choose your topic and difficulty level</span>
			</div>
			<div class="flex items-center gap-4">
				<div class="flex-shrink-0 bg-[#004AAD] text-white rounded-full w-7 h-7 flex items-center justify-center">
			...
			<div class="flex items-center gap-4">
				...
				<span class="text-gray-800 dark:text-gray-200">Enjoy AI-powered personalized learning</span>
			</div>
		</div>
		...
		<div class="flex items-center justify-center gap-2 mt-4">
			<input type="checkbox" id="dontShow" bind:checked={dontShowAgain} class="h-4 w-4 text-indigo-600 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
			<label for="dontShow" class="text-sm text-gray-500 dark:text-gray-400">Don't show me again</label>
		</div>
	</div>
</div>
{/if}
