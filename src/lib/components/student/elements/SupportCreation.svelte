...
<script lang="ts">
	...
	import FileManager from '$lib/components/student/elements/FileManager.svelte';
...
>
				...
				{:else if currentStep === 1}
						...
						<!-- ↓ NEW: drop-in FileManager replacing the old upload block -->
						<FileManager bind:files={uploadedFiles} />
						<!-- ↑ That's it. bind:files keeps uploadedFiles in sync. -->
					</div>
