<script lang="ts">
            ...
            {#each avatars as avatar}
              ...
              >
                <div 
                  ...
                  style="--accent-color: {avatar.accentColor}; {selectedAvatar === avatar.id ? `border: 2px solid ${avatar.accentColor}` : ''}"
                >
                  <!-- Card background with subtle pattern -->
                  <div class="card-bg" style="background-image: url('static/images/background.jpeg')"></div>
                  ...
                  <div class="vertical-avatar-info">
                    <div class="name-badge" style="background: linear-gradient(135deg, {avatar.accentColor}, {avatar.gradientEnd})">
            ...
            <div class="carousel-overflow">
              ...
              >
                {#each avatars as avatar, i}
                  <div 
                    class="avatar-item {selectedAvatar === avatar.id ? 'selected' : ''}"
                  >
                    <!-- Avatar card -->
                    <div 
                      class="avatar-card"
                    ...
                    >
                      ...
                      <div class="card-title" style="background: linear-gradient(135deg, {avatar.accentColor}, {avatar.gradientEnd})">
  ...
  <style>
    ...
    :global(:not(.dark)) .vertical-avatar-card {
      ...
      box-shadow: 0 8px 15px rgba(0, 0, 0, 0.12), 0 3px 8px rgba(0, 0, 0, 0.08);
    ...
    .vertical-avatar-card:hover {
      ...
      box-shadow: 0 15px 30px -5px rgba(0, 0, 0, 0.5), 0 0 15px rgba(var(--accent-color-rgb, 33, 150, 243), 0.3);
    }
  
    :global(:not(.dark)) .vertical-avatar-card:hover {
      transform: translateY(-5px) scale(1.01);
      filter: drop-shadow(0 8px 16px rgba(0, 0, 0, 0.15));
      box-shadow: 0 10px 18px rgba(0, 0, 0, 0.1), 0 4px 10px rgba(0, 0, 0, 0.06);
    }
  
    .vertical-avatar-item.selected .vertical-avatar-card {
      box-shadow: 0 0 0 2px var(--accent-color), 0 15px 30px -5px rgba(0, 0, 0, 0.3), 0 0 15px rgba(var(--accent-color-rgb, 33, 150, 243), 0.5);
    }
  
    :global(:not(.dark)) .vertical-avatar-item.selected .vertical-avatar-card {
      filter: drop-shadow(0 8px 15px rgba(0, 0, 0, 0.12)) drop-shadow(0 0 12px rgba(var(--accent-color-rgb, 33, 150, 243), 0.2));
      box-shadow: 0 0 0 2px var(--accent-color), 0 10px 18px rgba(0, 0, 0, 0.1), 0 4px 8px rgba(0, 0, 0, 0.06);
    ...
    .avatar-card:hover {
      transform: translateY(-10px);
      box-shadow: 0 20px 40px rgba(0, 0, 0, 0.4), 0 0 20px rgba(var(--accent-color-rgb, 33, 150, 243), 0.3);
    }
  
    :global(:not(.dark)) .avatar-card:hover {
      filter: drop-shadow(0 8px 20px rgba(0, 0, 0, 0.2));
      box-shadow: 0 15px 25px rgba(0, 0, 0, 0.12), 0 5px 12px rgba(0, 0, 0, 0.08);
      transform: translateY(-10px) scale(1.02);
    }
  
    .avatar-item.selected .avatar-card {
      box-shadow: 0 0 0 2px var(--accent-color), 0 20px 40px rgba(0, 0, 0, 0.4), 0 0 30px rgba(var(--accent-color-rgb, 33, 150, 243), 0.4);
      border-color: var(--accent-color);
    }
  
    :global(:not(.dark)) .avatar-item.selected .avatar-card {
      filter: drop-shadow(0 10px 20px rgba(0, 0, 0, 0.15)) drop-shadow(0 0 15px rgba(var(--accent-color-rgb, 33, 150, 243), 0.25));
      box-shadow: 0 0 0 3px var(--accent-color), 0 12px 20px rgba(0, 0, 0, 0.12), 0 5px 12px rgba(0, 0, 0, 0.08);
      border-color: var(--accent-color);
      background-color: rgba(30, 30, 40, 0.95);
    }
