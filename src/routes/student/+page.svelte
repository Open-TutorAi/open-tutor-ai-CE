...
{:else if error}
  <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
    <div class="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
      <h1 class="text-3xl font-bold text-center mb-4 text-red-600">{$i18n.t('Error Loading Student Page')}</h1>
...
{:else}
  <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
    <div class="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
      <h1 class="text-3xl font-bold text-center mb-8 text-gray-800 dark:text-white">{$i18n.t('Student Page')}</h1>
      
      <div class="space-y-6">
        <div class="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
          <h2 class="text-xl font-semibold mb-4 text-blue-700 dark:text-blue-300">{$i18n.t('Welcome to Your Learning Dashboard')}</h2>
          <p class="text-gray-700 dark:text-gray-300">
            {$i18n.t('This is your personalized learning space. Here you can access your courses, assignments, and track your progress.')}
          </p>
          {#if $user}
