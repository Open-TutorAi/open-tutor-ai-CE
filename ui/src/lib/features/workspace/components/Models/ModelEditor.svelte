<script lang="ts">
	...
	import Knowledge from '$lib/features/workspace/components/Models/Knowledge.svelte';
	import ToolsSelector from '$lib/features/workspace/components/Models/ToolsSelector.svelte';
	import FiltersSelector from '$lib/features/workspace/components/Models/FiltersSelector.svelte';
	import ActionsSelector from '$lib/features/workspace/components/Models/ActionsSelector.svelte';
	import Capabilities from '$lib/features/workspace/components/Models/Capabilities.svelte';
