<script lang="ts">
	...
	import Error from '$lib/features/chat/components/Messages/Error.svelte';
	import Citations from '$lib/features/chat/components/Messages/Citations.svelte';
	import CodeExecutions from '$lib/features/chat/components/Messages/CodeExecutions.svelte';
	import ContentRenderer from '$lib/features/chat/components/Messages/ContentRenderer.svelte';
