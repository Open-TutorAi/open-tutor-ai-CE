<script lang="ts">
	...
	import CodeBlock from '$lib/features/chat/components/Messages/CodeBlock.svelte';
	import MarkdownInlineTokens from '$lib/features/chat/components/Messages/Markdown/MarkdownInlineTokens.svelte';
