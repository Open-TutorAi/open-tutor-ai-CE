<script lang="ts">
	...
	import AddMemoryModal from '$lib/features/chat/components/Settings/Personalization/AddMemoryModal.svelte';
	import { deleteMemoriesByUserId, deleteMemoryById, getMemories } from '$lib/apis/memories';
	import Tooltip from '$lib/ui/Tooltip.svelte';
	import { error } from '@sveltejs/kit';
	import EditMemoryModal from '$lib/features/chat/components/Settings/Personalization/EditMemoryModal.svelte';
