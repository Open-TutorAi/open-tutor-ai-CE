<script>
	...
	import Leaderboard from '$lib/features/admin/components/Evaluations/Leaderboard.svelte';
	import Feedbacks from '$lib/features/admin/components/Evaluations/Feedbacks.svelte';
