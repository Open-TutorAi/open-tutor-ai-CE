<script lang="ts">
	...
	import Connections from '$lib/features/admin/components/Settings/Connections.svelte';
	import Models from '$lib/features/admin/components/Settings/Models.svelte';
	import KnowledgeRAG from '$lib/features/admin/components/Settings/KnowledgeRAG.svelte';
	import TutorMedia from '$lib/features/admin/components/Settings/TutorMedia.svelte';
	import TutorBehavior from '$lib/features/admin/components/Settings/TutorBehavior.svelte';
	import SystemPanel from '$lib/features/admin/components/Settings/SystemPanel.svelte';
