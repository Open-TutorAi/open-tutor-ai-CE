<script>
	...
	import ManageOllama from '$lib/features/admin/components/Settings/Models/Manage/ManageOllama.svelte';
	import { getOllamaConfig } from '$lib/apis/ollama';
	import Spinner from '$lib/ui/Spinner.svelte';
	import ManageMultipleOllama from '$lib/features/admin/components/Settings/Models/Manage/ManageMultipleOllama.svelte';
